...
sc.add_to_subplot(v_obj_mip, row=0, col=0, title='MIP rendering', zoom=.7, rotate='side-fl')

###############################################################################
# Translucent renderingyoutube
...
sc.add_to_subplot(v_obj_add, row=0, col=2, title='Additive rendering', zoom=.6, rotate='side-fl')
...
sc.add_to_subplot(vol_obj_sec, row=1, col=3, zoom=.7,
                  title='MRI file (translucent rendering)' , rotate='side-fl')

# Finally, display the scene
sc.record_animation('brain.gif')