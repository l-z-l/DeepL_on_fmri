...
def network_graph(yearRange, AccountToSearch):
    ...
    if len(shell2)==0:
        ...
        figure = {
            "data": traceRecode,
            "layout": go.Layout(title='Interactive Brain Network Visualization', showlegend=False,
    ...
    for node in G.nodes():
        ...
        hovertext = "Atlas Name: " + str(G.nodes[node]['CustomerName']) + "<br>" + "Atlas Type: " + str(
            G.nodes[node]['Type'])
...
app.layout = html.Div([
    #########################Title
    html.Div([html.H1("Brain Network Maps")],
             className="row",
    ...
    html.Div(
        ...
        children=[
            ...
            html.Div(
                ...
                children=[
                    dcc.Markdown(d("""
                            **Level of Graph To Visualize**

                            Slide the bar to define layer.
                            """)),
                    html.Div(
